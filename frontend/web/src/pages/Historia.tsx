    ...
    <main className="flex flex-col gap-8 px-4 py-8 max-w-screen-xl mx-auto m-[0%] p-[2%] font-sans">
     <section className="bg-celeste text-blanco px-4 py-8  rounded-[1rem] font-bold font-poetsen">
      ...
      <div className="space-y-6 text-blancotext-base leading-relaxed text-negro_texto">
        ...
        <p>
          Desde el primer día, el equipo sénior fue el alma de los pueblos cercanos. <strong> Campillo del Río, Torreblascopedro y Vados de Torralba </strong> aportaron no solo jugadores, sino también cercanía, amistad y compromiso con el proyecto. Con el tiempo, el equipo fue creciendo con la llegada de compañeros de <strong>Villagordo y Linares</strong>, unidos por una misma pasión y una conexión entre pueblos que trasciende los límites del campo.
        </p>
        <p>
