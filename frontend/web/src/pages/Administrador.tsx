...
export default function AdministradorPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-gray-50">
      {/* Menú lateral */}
      {adminData && (
        <aside className="bg-celeste text-white h-auto px-6 py-10 rounded-[1rem] font-poetsen font-bold md:w-full max-w-full m-[1.5rem] md:max-w-[20rem] md:w-1/4 flex flex-col justify-center items-center space-y-4">
          <button
            onClick={() => navigate("/usuario")}
            className="min-w-[14rem] px-4 py-2 rounded-full border-2 font-bold transition-colors duration-200 bg-blanco text-azul border-azul hover:bg-azul hover:text-blanco"
          >
            Zona Usuario
          </button>
